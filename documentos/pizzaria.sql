...
--
-- Table structure for table `tbl_pizzadoce`
--

DROP TABLE IF EXISTS `tbl_pizzadoce`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!40101 SET character_set_client = utf8 */;
CREATE TABLE `tbl_pizzadoce` (
  `id` int(11) NOT NULL AUTO_INCREMENT,
  `imagem1` varchar(200) DEFAULT NULL,
  ...
  `imagem3` varchar(200) DEFAULT NULL,
  `nome3` varchar(100) DEFAULT NULL,
  `imagem4` varchar(200) DEFAULT NULL,
  `nome4` varchar(100) DEFAULT NULL,
  `imagem5` varchar(200) DEFAULT NULL,
  `nome5` varchar(100) DEFAULT NULL,
  `imagem6` varchar(200) DEFAULT NULL,
  `nome6` varchar(100) DEFAULT NULL,
  `ativar` tinyint(1) DEFAULT NULL,
  PRIMARY KEY (`id`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8;
/*!40101 SET character_set_client = @saved_cs_client */;
...
--
-- Dumping data for table `tbl_pizzadoce`
--

LOCK TABLES `tbl_pizzadoce` WRITE;
/*!40000 ALTER TABLE `tbl_pizzadoce` DISABLE KEYS */;
/*!40000 ALTER TABLE `tbl_pizzadoce` ENABLE KEYS */;
UNLOCK TABLES;
...
--
-- Table structure for table `tbl_pizzasalgada`
--

DROP TABLE IF EXISTS `tbl_pizzasalgada`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!40101 SET character_set_client = utf8 */;
CREATE TABLE `tbl_pizzasalgada` (
  `id` int(11) NOT NULL AUTO_INCREMENT,
  `imagem1` varchar(200) DEFAULT NULL,
  `nome1` varchar(100) DEFAULT NULL,
  `imagem2` varchar(200) DEFAULT NULL,
...
--
-- Dumping data for table `tbl_pizzasalgada`
--

LOCK TABLES `tbl_pizzasalgada` WRITE;
/*!40000 ALTER TABLE `tbl_pizzasalgada` DISABLE KEYS */;
/*!40000 ALTER TABLE `tbl_pizzasalgada` ENABLE KEYS */;
UNLOCK TABLES;
...
INSERT INTO `tbl_usuario` VALUES (9,'admin','011 4321-5604','admin@admin.com','admin','123',NULL,NULL),(10,'Marcel teste','011 4772-4700','marcel@gmail.com','marcelnt','123',NULL,NULL),(12,'Gabriel de Melo Marcondes','011 4707-2731','gabriel-santos1313@hotmail.com','gabriel','127',NULL,NULL),(13,'Bruna linda','011 4321-5604','bruna@gmail.com','bruna','123',NULL,NULL),(14,'joao','011 9568-5236','joao@gmail.com','joao','147',NULL,NULL);
...
-- Dump completed on 2017-11-10 16:57:09
