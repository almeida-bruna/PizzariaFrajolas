					...
					if(move_uploaded_file($_FILES['flefoto4']['tmp_name'], $upload_file4)){
                        ...
                        if(move_uploaded_file($_FILES['flefoto5']['tmp_name'], $upload_file5)){
                            ...
                            if(move_uploaded_file($_FILES['flefoto6']['tmp_name'], $upload_file6)){
                                ...
                                $sql="insert into tbl_pizzasalgada (imagem1,nome1,imagem2,nome2,
                                ...
                                mysql_query($sql);
                                //echo($sql);
                                header('location:pizzaSalgada_CMS.php');
                         }
					  }
                   }
				}	
...
if(isset($_GET['modo'])){
    ...
    if($modo=='excluir'){
        ...
        $sql = "delete from tbl_pizzasalgada where id=".$id;
        ...
        $sql="update tbl_pizzasalgada set ativar='".$modo."'where id='".$id."'";
...
<html>
    <head>
        <meta charset="utf-8"/>
        <title>Pizzas Salgada CMS</title>
        <link rel="stylesheet" type="text/css" href="Css/style_pizzaSalgadaCMS.css"/>
    ...
    <body>
        ...
        <div id="principal">
            ...
            <div id="main">
				...
				<div class="conteiner">
                    <div id="cad">
						<div id="title">Pizzas Salgada</div>
                        <form name="frmupload" method="post" enctype="multipart/form-data" action="pizzaSalgada_CMS.php">
                    ...
                    <table id="tabela2">
						...
						<?php
                                $sql="select * from tbl_pizzasalgada order by id desc";
                        ...
                        <tr class="linha2">
                            ...
                            <td class="td">
								<a href="pizzaSalgada_CMS.php?modo=ativar&id=<?php
                                   echo($rs['id'])?>">
                                <img src="Imagens/accept.png" alt="selecionado"/>
                                </a>
                                
                                <a href="pizzaSalgada_CMS.php?modo=excluir&id=<?php
                                   echo($rs['id'])?>">
